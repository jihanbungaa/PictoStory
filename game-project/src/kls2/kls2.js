class PuzzleGame {
    constructor() {
        this.currentLevel = 1;
        this.stories = [
            "🌳Menangis dan sepeda nya 🎈",
            
            "🐱Lina dan alin sedang mengobrol dan tertawa✨",
        ];
    ...
    setupLevel() {
        ...
        pieces.forEach(num => {
            ...
            if (this.currentLevel === 1) {
                piece.src = `../assets/img/puzzle(4)${num}.png`; // Level 1 assets
            } else {
                piece.src = `../assets/img/gambar(5)${num}.png`; // Level 2 assets
            }
    ...
    setupEventListeners() {
        ...
        this.promoteBtn.addEventListener('click', () => {
            window.location.href = '../kls3/kls3.html';
        });
    }
